...
TEST_CASE("proxy interner", "[mvll][wayland][client][reflector]") {
    ...
    std::cout << proxy_interner<"wl_display">::name << std::endl;
    std::cout << proxy_interner<"wl_display">::deleter << std::endl;
    std::cout << to_tuple(*proxy_interner<"wl_display">::interface_ptr) << std::endl;
    std::cout << to_tuple(*proxy_interner<"wl_registry">::interface_ptr) << std::endl;
    std::cout << to_tuple(*proxy_interner<"wl_compositor">::interface_ptr) << std::endl;
    std::cout << typeid (proxy_interner<"wl_display">::listener_type).name() << std::endl;
    std::cout << typeid (proxy_interner<"wl_registry">::listener_type).name() << std::endl;
    std::cout << typeid (proxy_interner<"wl_compositor">::listener_type).name() << std::endl;
}
